        ...
        $group: {
          ...
          detail_items: {
            $push: {
              ...
              remarks: '$remarks',
              execution_rate: {
                $divide: ['$detail_item_settlement', '$detail_item_budget'],
              },
            },
          },
        },
        ...
        $group: {
          ...
          sub_items: {
            $push: {
              ...
              sub_item_execution_rate: {
                $divide: ['$sub_item_settlement', '$sub_item_budget'],
              },
      ...
      },
      {
        $project: {
          ...
          total_execution_rate: {
            $divide: ['$total_settlement', '$total_budget'],
          },
          sub_items: '$sub_items',
        },
      },
